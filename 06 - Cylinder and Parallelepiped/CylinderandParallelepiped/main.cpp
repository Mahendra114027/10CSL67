//Including libraries header files
#include <GL/glut.h>
#include <math.h>
#include <stdio.h>

//Function to mark pixels
...
void Circle_draw(GLint h, GLint k, GLint r)
{
	...
	while(x < y)
	{
		...
		if(d < 0)	//Select East, here x coordinate increments and y remains unchanged
			d+=2*x+3;

		else	//Select SouthEast, here x is incremented and y is decremented
		{
			d+=2*(x-y)+5;
			--y;
		}
...
{
	//Declaration and initialisation of coordinates
